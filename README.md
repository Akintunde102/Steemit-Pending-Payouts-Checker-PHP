# SteemitPendingPayoutsCheckerPHP
...
**License URI:** https://www.apache.org/licenses/LICENSE2.0 <br/>
...
## Description:
This script helps to solve the ambiguity associated with knowing the expected payout of a user at any 7 day period which is the interval of payment for every comment or post made on steemit.com, utopianio, busy.org, zappl and the rest of the apps that use the steem blockchain.<br/>
...
1. Download this script as a zip file (from the github page https://github.com/Akintunde102/SteemitPendingPayoutsCheckerPHP)
